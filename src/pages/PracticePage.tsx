  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 select-none font-mono">
      ...
      <div className="border-b border-[#E5E5E5] pb-6 space-y-1">
        ...
        <p className="text-xs sm:text-sm text-[#555555] max-w-2xl leading-relaxed font-sans">
          Solve byte-sized capture-the-flag missions to hone your technical and theoretical security knowledge.
        </p>
      </div>

      {/* Category Tabs */}
      <div className="flex gap-2 border-b border-[#E5E5E5] pb-3 flex-wrap">
        {([
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded text-xs font-mono transition-all cursor-pointer border uppercase tracking-wider ${
              selectedCategory === cat
                ...
                : 'bg-white border-[#E5E5E5] text-[#555555] hover:text-[#111111] hover:border-[#111111]'
            }`}
          >
            {cat}
          </button>
          ...
          return (
            ...
            >
              <div className="flex-1 space-y-3">
                <div className="flex items-center gap-3 flex-wrap border-b border-[#E5E5E5] pb-3">
                  <span className="text-xs text-[#111111] font-bold tracking-widest">
                    MISSION {missionNum}
                  </span>
                  <span className="text-[10px] uppercase font-bold text-[#888888]">{challenge.category}</span>
                  <span className="px-2 py-0.5 rounded text-[9px] border border-[#E5E5E5] bg-[#F7F7F7] text-[#111111] font-bold uppercase">
                  ...
                  <span className={`px-2 py-0.5 rounded text-[9px] font-bold border ${
                    solved ? 'bg-[#111111] text-white border-[#111111]' : 'bg-[#F7F7F7] text-[#888888] border-[#E5E5E5]'
                  }`}>
                ...
                <div className="space-y-1">
                  <h3 className="text-base font-extrabold text-[#111111] font-heading tracking-wide uppercase flex items-center gap-2">
                    {challenge.title}
                    {solved && <CheckCircle size={16} className="text-emerald-600 shrink-0" />}
                  </h3>
                  <p className="text-xs text-[#555555] font-sans leading-relaxed max-w-2xl">
                ...
                <div>
                  <button
                    ...
                    className="text-[10px] text-[#888888] hover:text-[#111111] flex items-center gap-1 cursor-pointer font-bold"
                  >
                  ...
                  {showHints[challenge.id] && (
                    <div className="mt-2 p-3 rounded border border-[#E5E5E5] bg-[#F7F7F7] text-xs text-[#555555] max-w-md font-mono">
                      {challenge.hint}
                    </div>
                  )}
                </div>
              ...
              {/* Input Form */}
              <div className="w-full md:w-72 shrink-0 flex flex-col gap-3 pt-4 md:pt-0 md:pl-6 border-t md:border-t-0 md:border-l border-[#E5E5E5] self-stretch justify-center">
                <div className="space-y-2">
                  <input
                    ...
                    className="w-full bg-[#F7F7F7] border border-[#E5E5E5] rounded px-3 py-2 text-xs text-[#111111] outline-none focus:border-[#111111] disabled:opacity-60 placeholder-[#888888] font-mono"
                  />
                  <button
                    disabled={solved}
