            ...
            <div 
              ...
              className={`p-6 rounded-md border flex flex-col items-center text-center space-y-4 transition-all ${
                isUnlocked 
                  ...
                  : 'bg-[#FAFAFA] border-[#E5E5E5] opacity-60'
              }`}
            >
              {/* Badge Icon */}
              <div className={`w-14 h-14 rounded-full flex items-center justify-center border transition-all ${
                isUnlocked 
                  ...
                  : 'bg-[#F7F7F7] border-[#E5E5E5] text-[#888888]'
              }`}>
              ...
              <div className="space-y-1">
                <h3 className="text-sm font-extrabold tracking-wide uppercase font-heading text-[#111111]">
                  {badge.title}
                </h3>
                <p className="text-xs text-[#555555] leading-relaxed font-sans max-w-[200px] mx-auto">
                  {badge.description}
                </p>
              </div>

              {/* Status Tag */}
              <div className="pt-3 border-t border-[#E5E5E5] w-full text-[10px] font-mono">
                {isUnlocked ? (
                  <span className="text-[#111111] font-extrabold tracking-widest uppercase">
                    ✓ UNLOCKED (+{badge.xpReward} XP)
                  </span>
                ) : (
                  <span className="text-[#888888] tracking-widest uppercase font-bold">
                    LOCKED
                  </span>
                )}
              </div>
