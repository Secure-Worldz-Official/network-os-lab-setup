...
export function LeaderboardPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 select-none font-mono">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#E5E5E5] pb-6">
        <div className="space-y-1">
          <div className="text-[10px] uppercase font-bold text-[#888888] tracking-widest flex items-center gap-1.5">
            <BarChart2 size={14} className="text-[#111111]" />
        ...
        {/* Filters */}
        <div className="flex gap-1 border border-[#E5E5E5] p-1 rounded bg-[#F7F7F7] shrink-0 self-start sm:self-auto">
      ...
      {/* Ranking Table */}
      <div className="rounded-md border border-[#E5E5E5] bg-white shadow-sm overflow-hidden font-mono">
        <div className="flex items-center justify-between px-4 py-3 bg-[#F7F7F7] border-b border-[#E5E5E5]">
          <div className="flex items-center gap-2">
            <BarChart2 size={14} className="text-[#111111]" />
            <span className="text-[10px] font-extrabold tracking-widest text-[#111111] uppercase">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse text-xs">
            <thead>
              <tr className="border-b border-[#E5E5E5] bg-white text-[#888888] text-[10px] uppercase font-bold tracking-widest">
                    ...
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-2.5">
                        <span className={cn(
                          ...
                          user.isCurrentUser ? 'bg-white' : 'bg-[#111111]'
                        )} />
