    ...
    <div className="max-w-6xl mx-auto space-y-8 select-none font-mono">
      ...
      <div className="border-b border-[#E5E5E5] pb-6">
        <div className="flex items-center gap-2 text-xs font-bold text-[#888888] uppercase tracking-widest mb-1">
          <Compass size={14} className="text-[#111111]" />
      ...
      <div className="space-y-6">
        {learningPaths.map((path) => {
          ...
          return (
            <div key={path.id} className="p-6 rounded-md border border-[#E5E5E5] bg-white space-y-6 shadow-sm">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-[#E5E5E5] pb-4">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-[#F7F7F7] border border-[#E5E5E5] text-[#111111] uppercase">
                      {path.difficulty}
                    </span>
              ...
              <div className="space-y-3 pt-2">
                <span className="text-[10px] font-bold uppercase text-[#888888] tracking-widest block">
                  CURRICULUM MODULES & PRACTICAL STAGES
                </span>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 text-xs">
                  {modules.map((m) => (
                    <div key={m} className="p-3 rounded bg-[#F7F7F7] border border-[#E5E5E5] text-[#111111] font-bold flex items-center gap-2">
                      <Terminal size={13} className="text-[#111111] shrink-0" />
