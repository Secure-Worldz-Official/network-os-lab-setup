    ...
    <div className="max-w-7xl mx-auto space-y-8 select-none font-mono">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#E5E5E5] pb-6">
        <div className="space-y-1">
          <div className="text-[10px] text-[#888888] font-bold uppercase tracking-widest flex items-center gap-1.5">
            <Terminal size={14} className="text-[#111111]" />
        ...
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full bg-[#F7F7F7] border border-[#E5E5E5] rounded px-9 py-2 text-xs text-[#111111] outline-none focus:border-[#111111] placeholder-[#888888] font-mono"
          />
        </div>
      </div>
            ...
            >
              <div className="space-y-4">
                <div className="flex items-center justify-between gap-3 border-b border-[#E5E5E5] pb-3">
                  <span className="text-[10px] uppercase tracking-widest font-bold text-[#888888]">{room.category}</span>
                  <span className={`px-2 py-0.5 rounded text-[9px] font-mono border ${
                    isDone 
                      ? 'bg-[#111111] text-white border-[#111111] font-bold' 
                      : completedCount > 0
                      ? 'bg-[#F7F7F7] text-[#111111] border-[#111111] font-bold'
                      : 'bg-[#F7F7F7] text-[#888888] border-[#E5E5E5]'
                  }`}>
                ...
                <div className="space-y-2">
                  <h3 className="text-lg font-extrabold text-[#111111] font-heading tracking-wide uppercase leading-tight">
                    {room.title}
                  </h3>
                  <p className="text-xs text-[#555555] font-sans line-clamp-3 leading-relaxed">
                    {room.description}
                  </p>
                </div>
              </div>
                ...
                <div className="flex items-center justify-between gap-2">
                  <div className="flex flex-wrap gap-1">
                    {room.skills.slice(0, 2).map((skill) => (
                      <span 
                        key={skill}
                        className="px-2 py-0.5 rounded bg-[#F7F7F7] border border-[#E5E5E5] text-[9px] text-[#555555] uppercase"
                      >
                        {skill}
                      </span>
                    ))}
