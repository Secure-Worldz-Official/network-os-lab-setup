...
export function ProfilePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 select-none font-mono">
      ...
      {/* USER SUMMARY BANNER */}
      <div className="p-6 sm:p-8 rounded-md border border-[#E5E5E5] dark:border-[#2A2A2A] bg-[#FAFAFA] dark:bg-[#141414] flex flex-col sm:flex-row items-center justify-between gap-6 relative overflow-hidden shadow-sm">
        <div className="flex flex-col sm:flex-row items-center gap-5 text-center sm:text-left">
          <div className="w-16 h-16 rounded-full bg-[#111111] dark:bg-white flex items-center justify-center text-white dark:text-[#080808] font-mono text-xl font-bold uppercase">
            {username.slice(0, 2)}
          </div>
          <div className="space-y-1">
            <h1 className="text-xl sm:text-3xl font-extrabold text-[#111111] dark:text-white font-heading tracking-tight uppercase">{username}</h1>
        ...
        <div className="flex gap-6 text-center shrink-0 border-t sm:border-t-0 sm:border-l border-[#E5E5E5] dark:border-[#2A2A2A] pt-4 sm:pt-0 sm:pl-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="p-6 rounded-md border border-[#E5E5E5] dark:border-[#2A2A2A] bg-white dark:bg-[#141414] space-y-4 shadow-sm">
            ...
            <div className="grid grid-cols-7 gap-1 bg-[#F7F7F7] dark:bg-[#181818] p-3 rounded border border-[#E5E5E5] dark:border-[#2A2A2A]">
              {Object.entries(streakDays).map(([day, checked]) => (
                <div key={day} className="flex flex-col items-center gap-1.5">
                  <span className="text-[9px] text-[#888888] dark:text-[#777777] font-bold">{day}</span>
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="p-6 rounded-md border border-[#E5E5E5] dark:border-[#2A2A2A] bg-white dark:bg-[#141414] space-y-4 shadow-sm">
            ...
            {unlockedBadges.length === 0 ? (
              <p className="text-xs text-[#555555] dark:text-[#B5B5B5] font-sans leading-normal">
