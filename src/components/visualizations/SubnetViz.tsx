...
const CIDR_DATA: Record<CidrPrefix, SubnetInfo> = {
  24: {
    ...
    usableHosts: 254,
    blocks: [
      { id: 1, network: '192.168.1.0', range: '.1 – .254', broadcast: '192.168.1.255' }
    ]
  },
  25: {
    prefix: 25,
...
export function SubnetViz() {
  ...
  return (
    <div className="space-y-5 font-mono select-none w-full">
      ...
      {/* Interactive Subnet Visual Canvas */}
      <div className="relative rounded-2xl border border-[#E5E5E5] dark:border-[#2A2A2A] bg-white dark:bg-[#101010] p-6 space-y-5 shadow-sm">
        {/* Parent /24 Banner */}
        <div className="p-4 rounded-xl border border-[#111111] dark:border-white bg-[#FAFAFA] dark:bg-[#181818] flex items-center justify-between text-xs">
          ...
          {info.blocks.map((block) => {
            ...
            return (
              <button
                ...
                className={`p-4 rounded-xl border text-left transition-all cursor-pointer font-mono ${
                  isSelected
      ...
      <div className="p-5 rounded-xl border border-[#E5E5E5] dark:border-[#2A2A2A] bg-white dark:bg-[#141414] space-y-4 shadow-xs">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
          ...
          <div className="p-3 rounded-lg bg-[#F7F7F7] dark:bg-[#181818] border border-[#E5E5E5] dark:border-[#2A2A2A] space-y-1">
            ...
            <span className="font-extrabold text-sm text-emerald-600 dark:text-emerald-400 font-mono">192.168.1{activeBlock.range}</span>
          </div>
          <div className="p-3 rounded-lg bg-[#F7F7F7] dark:bg-[#181818] border border-[#E5E5E5] dark:border-[#2A2A2A] space-y-1">
